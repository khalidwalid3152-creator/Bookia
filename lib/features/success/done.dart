        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Your password has been changed ',style: textstyles.size16(color: Appcolors.textcolor),),
              Text('successfully.',style: textstyles.size16(color: Appcolors.textcolor),),
              Gap(10),
              _Button(context)
            ],
          ),
