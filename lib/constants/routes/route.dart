...
import 'package:bookia/features/main/mainApp_screen.dart';
...
class Routes {
  ...
  static GoRouter routes = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: login, builder: (context, state) =>BlocProvider(create: (context)=> AuthCubit(),child: Login())),
      ...
      GoRoute(path: mainappscreen, builder: (context, state) => MainappScreen()),
